...
%    Shape: (112848, 3)
%    Columns: ['text', 'generated', 'perplexity']
%    🧠 Perplexity available for 112844/112848 samples (100.0%)
% 💾 Dataset metadata saved: data/datasets/dataset_metadata.json

% Sources:
% [ENABLED] hc3                      :   85431 total (H: 58546, AI: 26885) → 43000 samples (50.33% of source, 38.10% of combined)
% [ENABLED] daigt_v2                 :   44868 total (H: 27371, AI: 17497) → 34994 samples (77.99% of source, 31.01% of combined)
% [ENABLED] sunilthite               :   29145 total (H: 17508, AI: 11637) → 23274 samples (79.86% of source, 20.62% of combined)
% [ENABLED] ah_aitd                  :   11580 total (H:  5790, AI:  5790) → 11580 samples (100.00% of source, 10.26% of combined)
% Combined Dataset Head: 

%                                                 text  generated  perplexity
% 0  It is possible that the pain you are experienc...          1    4.157336
% 1  Okay, I'll give it a shot! Here's my essay:\n\...          1    4.956675
% 2  The importance of the thermal properties of in...          1   26.813772
% 3  Depends on the drug . Heroin and other narcoti...          0   14.745926
% 4  What object ? Mercury does n't have any satell...          0  105.859143


% Shape: (112848, 3)
% Human Written: 56424 (50.00%)
% Ai Generated: 56424 (50.00%)